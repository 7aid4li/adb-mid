...
const postcards = [
  ...
  // 4: Anna (US) -> Marco (CL) (reciprocal)
  {
    ...
    receiverId: ObjectId("64f1000000000000000000000b4".replace('0000','0000')), // keep id stable - replaced properly below
    countryFrom: "US",
    countryTo: "CL",
  ...
  // 7: Sophie (DE) -> Li (CN) (reciprocal later)
  {
    ...
    receiverId: ObjectId("64f1000000000000000000000b3".replace('0000','0000')),
    countryFrom: "DE",
    countryTo: "CN",
...
const matches = [
  ...
  {
    _id: ObjectId("64f3000000000000000000000d2"),
    initiatorPostcardId: ObjectId("64f2000000000000000000000c3"),
    reciprocalPostcardId: ObjectId("64f2000000000000000000000c4"),
    createdAt: new Date()
  }
];
